...
<form method="POST" action="{{ route('product.hd-update', ['id' => $proDuct->id]) }}" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-md-3 offset-md-2">
            ...
            <input type="text" class="form-control" name="chip" id="chip"
                value="{{ old('chip', optional($proDuct->product_description)->chip) }}">
        ...
        <div class="col-md-3">
            ...
            <input type="number" class="form-control" name="weight" id="weight" step="0.1"
                value="{{ old('weight', optional($proDuct->product_description)->weight) }}">
            ...
            <select name="front_camera" class="form-select" id="front-camera" required>
                ...
                @foreach($listFrontCamera as $frontCamera)
                    @if($frontCamera->id != $proDuct->product_description->front_camera->id)
                        <option value="{{ $frontCamera->id }}">{{ $frontCamera->resolution . ' ' . $frontCamera->record }}
                        </option>
                    @endif
                @endforeach
            </select>
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <input type="text" class="form-control" name="os" id="os"
                value="{{ old('os', $proDuct->product_description->os) }}">
    ...
    <div class="row">
        <div class="col-md-3 offset-md-6">
            ...
            <input type="text" class="form-control" name="sims" id="sims"
                value="{{ old('sims', $proDuct->product_description->sims) }}">
        ...
        <div class="col-md-3">
            ...
            <input type="number" class="form-control" name="battery" id="battery"
                value="{{ old('battery', $proDuct->product_description->battery) }}">
        ...
        <div class="col-md-3 offset-md-6">
            ...
            <input type="number" class="form-control" id="ram" name="ram"
                value="{{ old('ram', $proDuct->product_description->ram) }}">
            ...
            <tbody>
                @foreach($proDuct->product_detail as $productDetail)
                    <tr>
                        ...
                        <td><button type="button" class="btn btn-danger btn-xoa" data-id="{{ $productDetail->id }}">Xóa</button>
                        </td>
