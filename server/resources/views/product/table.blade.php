            ...
            @foreach($listProduct as $Product)
                <tr>
                    ...
                    <td class="chuc-nang-product">
                        <a href="{{ route('product.update-images', ['id' => $Product->id]) }}" class="btn btn-outline-info"
                            title="Cập nhật hình ảnh"><i class="fas fa-camera"></i></a> |
                        <a href="{{ route('product.update', ['id' => $Product->id]) }}" class="btn btn-outline-primary"
                            title="Cập nhật"><i class="fas fa-edit"></i></a> |
                        <a href="{{ route('product.detail', ['id' => $Product->id]) }}" class="btn btn-outline-info"
