    ...
    <div class="invoice mb-4">
        <div class="invoice-details mb-3">
            ...
            <div class="invoice-items mb-3">
                <table class="table table-striped">
                    ...
                    <tbody>
                        @foreach($invoiceDetails as $detail)
                            <tr>
                                <td>{{ $detail->product->name }} - {{ $detail->color->name }} -
                                    {{ $detail->capacity->name }}</td>
                ...
                <p class="total-customer-main">Tổng tiền: <strong class="total-customer">{{ $invoice->total_formatted }}
                        đ</strong> </p>
            </div>
        </div>
