        ...
        <table class="table">
            ...
            @foreach($listBrand as $Brand)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('brand.update', ['id' => $Brand->id]) }}" title="Cập nhật"
                            class="btn btn-outline-primary"><i class="fas fa-edit"></i></a> |
                        <a href="{{ route('brand.delete', ['id' => $Brand->id]) }}" title="Xóa"
                        ...
                        @foreach($listBrandDelete as $brandDelete)
                            <tr>
                                ...
                                <td><a href="{{ route('brand.restore', ['id' => $brandDelete->id])}}" title="Khôi phục">
                                    ...
                                    <a href="#"><i class="fas fa-info-circle" title="Chi tiết"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
